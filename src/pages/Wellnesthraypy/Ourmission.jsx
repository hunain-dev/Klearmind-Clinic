  ...
  return (
    <div className='h-full w-full mt-15 lg:px-40 px-4 '>
        <div  className='h-full rounded-4xl w-full overflow-hidden bg-[#FDF9E9] grid grid-cols-2'>
            ...
            <h3 className='figee lg:text-4xl text-[5vw] text-[#32140C] md:text-[4vw] lg:mt-9 mt-3'>At Home IV Therapy
            </h3>
            <h4 className='figee text-[#55504C] lg:mt-7 mt-3 text-[3.2vw] md:text-[1.7vw] lg:text-[1.2vw]'>Please note, an additional $75 fee (within 10 miles) applies for in-home services.</h4>
