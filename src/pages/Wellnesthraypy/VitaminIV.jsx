...
const VitaminIV = () => {
  ...
  <div className='h-full lg:p-4 lg:py-8 p-1 py-4 flex items-start justify-between flex-col'>
    ...
    <div className='flex items-center gap-2 justify-start '>
            ...
            <h3 className='figee lg:text-4xl text-3xl md:text-[3.5vw]  lg:mt-7 mt-5 text-[#32140C]'>The Power of Vitamin IV Therapy
            </h3>
    </div>

    <div className='w-full-400 lg:px-3 px-3 '>           
   
            <h4 className='figee lg:text-[2.3vh] md:text-[1.2vw]  text-[2.5vh] lg:pb-6 pb-5 lg:mt-8 mt-3 text-[#7D7871]'>
