...
const Journey = () => {
  return (
    <div className='h-full m-auto w-full lg:pb-0 pb-6  lg:px-45 px-0 lg:mt-15 md:mt-25 mt-10'>
        <div className="back relative h-full w-full  m-auto">
            ...
            <div className="absolute flex items-center lg:mt-25 mt-23  lg:gap-5 gap-3  justify-center flex-col text-center top-0 left-0 h-full w-full  ">
                ...
                <h1 className='fontspring text-[#32140C] md:text-[4.3vw] lg:mb-11 mb-9 lg:leading-14 leading-10 lg:text-[3.3vw] text-4xl'>It’s not just an <br /> appointment, it’s <br /> a Journey</h1>
