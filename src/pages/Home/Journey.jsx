        ...
        <div className="back relative h-full w-full  m-auto">
            ...
            <span className="figee lg:text-[2vh] md:text-[3vw] text-[3vw] text-gray-600 tracking-wide">
              The experience
                 ...
                 <h1 className='fontspring text-[#32140C] md:text-[4.3vw] lg:mb-11 mb-9 lg:leading-14 leading-9 lg:text-[3.3vw] text-[8vw]'>It’s not just an <br /> appointment, it’s <br /> a Journey</h1>

              <Button btn="Book an appointment" bgcolor="#FD8124" fontSize='lg:text-[1.7vh] md:text-[1.3vw] text-[3vw]' padding="lg:px-7 py-3 lg:py-3 md:px-5 md:py-3" border="" textcolor="white" to="https://calendly.com/admin-klearmindclinics/30min?month=2025-10" /> 
