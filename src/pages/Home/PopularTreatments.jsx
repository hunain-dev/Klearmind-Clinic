...
const PopularTreatments = () => {
  ...
  return (
    <div className="h-full lg:mt-30 mt-10 w-full grid lg:grid-cols-1">
      {/* Heading */}
      <div className="h-full w-full flex items-center justify-start lg:gap-1 flex-col">
        <h3 className="figee lg:text-[2vh] text-[3.5vw]">Our Most Requested Treatments</h3>
        <h3 className="figee lg:text-[2.3vw] text-3xl text-[#32140C]">Requested Treatments</h3>
      </div>
  ...
  <img
    className="lg:h-[27vw] w-full object-cover rounded-4xl transition-transform duration-700 ease-in-out hover:scale-110"
    src={elem.image}
    alt={elem.text}
  />
</div>
            ...
            <div className=" lg:px-6 text-center">
              <h2 className="figee lg:text-[1.8vw] text-[5vw] py-3 text-[#413D3D]">{elem.text}</h2>
