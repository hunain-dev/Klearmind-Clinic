    ...
    <div className='h-full  px-40  w-full grid grid-cols-2'>
      ...
      <div className='h-full  flex overflow-hidden items-center justify-between flex-col'>
          <div className=' w-full flex items-start justify-center text-center'>
            <h3 className='fontspring text-[3.3vw] leading-12 text-[#32140C]'>Bloom into the life <br /> you deserve with <br /> Klearmind</h3>
          </div>
          <div className=' w-full py-1 text-center gap-8 flex items-center justify-center flex-col px-9'>
            <h3 className='figee leading-6 text-[1vw] text-[#413f3f]'>Safe, evidence-based Ketamine infusions for psychiatric disorders <br /> and chronic pain management</h3>
...
/>            <Button btn="am i a candidate?" padding="py-3" border="border-gray-700" hoverEffect={false}/>
