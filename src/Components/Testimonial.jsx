...
const Testimonial = ({img}) => {
  ...
  return (
    <div className=' w-[78%] m-auto  mt-15'>
        <div className='h-full  m-auto grid grid-cols-2'>
         ...
         <div className='text-[#383736] figee mt-28 flex items-start justify-start flex-col gap-8 transition-all duration-500 ease-in-out'>
