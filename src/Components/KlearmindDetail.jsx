...
import fact2 from "../assets/images/pain.png";
...
const KlearmindDetail = () => {
  ...
  const data = [
    ...
    {
      id: 3,
      title: "Exploring the Benefits of Ketamine Therapy for Chronic Pain Management",
  ...
  const clientdetails = [
...

    {
      ...
      paragraphs: [
        "Ketamine has shown remarkable success in treating depression, even when other treatments fail.",
        "It works by restoring brain connections and boosting positive mood rapidly.",
      ],
    },
    {
      id: 3,
  ...
  return (
    <div className="w-full py-33 px-21">
      <Ketamine
