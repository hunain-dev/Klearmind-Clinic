  ...
  return (
    <div className=' w-full grid grid-cols-1 lg:gap-13 gap-4'>
        ...
        <div className='flex items-center gap-2 justify-center '>
            ...
            <h2 className='fontspring text-[#32140C] lg:text-5xl text-[7vw] lg:leading-12 leading-8 pb-2 lg:mt-2'>{text}
            </h2>
        ...
        <div className='h-full lg:px-39 px-4 '>
            <div className='h-full m-auto'>
                ...
                <img src={image} alt="" className='lg:h-full  md:h-[35vw]  h-[20vh] w-full lg:rounded-4xl  object-cover' />
            </div>
